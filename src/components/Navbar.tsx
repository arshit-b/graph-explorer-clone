		...
		<>
			<AppBar component={'nav'} className={'bg-black'}>
				<Toolbar className={'justify-between'}>
					...
					<NavLogo  onClick={() => handleClickNavItem('/')} sx={{ cursor: 'pointer', display: { xs: 'none', sm: 'block' } }}/>
			...
			<nav>
				...
				>
					<NavLogo onClick={() => handleClickNavItem('/')} sx={{cursor: 'pointer', p: 2, display: { xs: 'block', sm: 'none' } }}/>
					<Divider />
					<NavbarItems onClickItem={(_, path) => handleClickNavItem(path)}/>
				</Drawer>
			</nav>
